...
set.seed(101) #Allows us to always get the same "random" sample
  ...
  X_i <- runif(n, 0, 200) #Gives n random values from a uniform distribution between 15 to 45.

  beta0 <- 15 #Our choice for the y-intercept. 

  beta1 <- .1 #Our choice for the slope. 

  sigma <- 20 #Our choice for the std. deviation of the error terms.
